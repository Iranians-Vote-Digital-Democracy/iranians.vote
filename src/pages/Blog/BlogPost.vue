<template>
  <div class="tech-doc" dir="rtl">
    <div class="tech-doc__back-link-wrp">
      <app-button class="tech-doc__back-link" :icon-left="$icons.arrowLeft" scheme="none" color="none" size="none"
        @click="back">
...
const blog = computed(() => {
  return Object.entries(blogs).find(([path, module]) => {
    const { attributes } = module as any
...
const source = computed(() => {
  ...
  return (blog.value[1] as any).html
})
